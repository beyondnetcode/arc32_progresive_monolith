...
* **Mantenimiento:** Los humanos deben acordarse de actualizar el `AGENTS.md` si cambian un comando crítico de pruebas, o corren el riesgo de desorientar al agente. Se recomienda añadir una regla dentro del propio archivo que le recuerde al Agente actualizarlo tras cambios arquitectónicos.
