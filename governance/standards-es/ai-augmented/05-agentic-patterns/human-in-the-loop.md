...
El patrón **Human-in-the-Loop (HITL)** establece barreras forzadas en el flujo de ejecución donde el agente autónomo está obligado a pausar su estado y solicitar la aprobación humana explí­cita y fí­sica para continuar.

Nuestra arquitectura asume que **NINGíšN AGENTE ES 100% CONFIABLE** en escenarios con ramificaciones en el mundo fí­sico o legal.

## Â¿Qué decisiones requieren SIEMPRE aprobación humana?
...
3.  **Comunicaciones Externas Firmadas:** Enví­o de correos masivos a clientes reales, publicación en redes sociales corporativas en nombre de la marca, enví­o de ofertas comerciales vinculantes.
...
### A. Interrupción ví­a Tool Callback (Retrollamada de Herramienta)
...
3.  El Harness guarda el estado de la conversación y enví­a un webhook a un Canal de Aprobación de Slack o panel administrativo.
...
## Anti-Patrón Crí­tico: La Ilusión de Control
