...
El núcleo de la aplicación está completamente aislado del bloqueo de proveedor gracias a la estricta adherencia a la Arquitectura Hexagonal ([ADR-0002](../../../architecture/adrs-es/nodejs/0002-clean-architecture-nestjs.md)).
