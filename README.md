...
| Review the reference architecture | [Reference Blueprint](./architecture/blueprints/reference-blueprint.md) | [Authoritative Stack Index](./architecture/blueprints/authoritative-tech-stack.md) | Understand the target architecture and runtime selection model |
...
| **Principal / Staff Engineer** | [Agnostic Baseline](./architecture/blueprints/authoritative-tech-stack-agnostic.md) -> [Tactical Design Patterns](./architecture/adrs/core/0019-tactical-design-patterns-future-proofing.md) -> [Simplicity Checklist](./architecture/blueprints/simplicity-checklist-phase-01.md) | Helps validate implementation choices and avoid accidental complexity |
