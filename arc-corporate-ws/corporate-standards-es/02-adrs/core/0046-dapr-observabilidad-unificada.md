...
- [Reference Blueprint - Sección Observabilidad](../../01-architecture/reference-blueprint.md#31-patrón-de-contexto-general--stack-completo-con-niveles-de-gateway-y-bus-de-eventos-inyectable)
- [Engineering Manifesto - Aislamiento de Infraestructura](../../03-engineering/engineering-manifesto.md)
- [Authoritative Tech Stack - Frameworks Aprobados](../../01-architecture/authoritative-tech-stack.md)
