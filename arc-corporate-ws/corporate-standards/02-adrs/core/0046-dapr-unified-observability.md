...
- [Reference Blueprint - Observability Integration](../../01-architecture/reference-blueprint.md#31-patron-de-contexto-general--stack-completo-con-niveles-de-gateway-y-bus-de-eventos-inyectable)
- [Engineering Manifesto - Infrastructure Isolation](../../03-engineering/engineering-manifesto.md)
- [Authoritative Tech Stack - Validated Runtimes](../../01-architecture/authoritative-tech-stack.md)
