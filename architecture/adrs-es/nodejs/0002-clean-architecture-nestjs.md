...
La arquitectura se divide en tres capas explí­citas:
...
Las preocupaciones transversales (Registro, Auditorí­a, Rastreo Distribuido, Almacenamiento en Caché, Gestión de Transacciones) NUNCA deben acoplar rí­gidamente decoradores de librerí­as de terceros o SDKs dentro de las capas Core o de Aplicación.
...
- Toda la capa Core puede ser extraí­da y reutilizada en un framework diferente (Fastify, Express) con cero cambios.
