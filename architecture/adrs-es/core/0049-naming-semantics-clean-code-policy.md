...
## 1. Metadata
*   **ADR ID:** 0049
*   **Tí­tulo:** Estándares de Semántica y Nomenclatura Clean Code (E2E y Global)
...
La legibilidad del código es el factor determinante de la velocidad de evolución de un sistema a largo plazo. Este ADR establece una polí­tica corporativa obligatoria sobre la semántica y nomenclatura de código (E2E), garantizando que cualquier desarrollador o herramienta de IA pueda comprender la intención del código sin ambigí¼edades, reduciendo drásticamente la deuda técnica cognitiva en todo el monorepo.

---

## 2. Contexto del Problema
La falta de una polí­tica global y unificada de nomenclatura genera los siguientes problemas:
...
## 4. Polí­tica de Cumplimiento (Enforcement Policy)
Esta utilización es una **Polí­tica Requerida** y se auditará mediante:
