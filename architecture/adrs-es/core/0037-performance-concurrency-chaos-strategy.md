...
*   **Pruebas de Contrato**: **Pact JS**. Usado para verificar cargas íºtiles de gRPC y Eventos entre productores/consumidores antes del despliegue.
...
*   **Concepto**: 5,000 Usuarios Virtuales intentan comprar exactamente las íºltimas 5 unidades disponibles de un artí­culo de inventario simultáneamente (ventana de 100ms).
...
#### Escenario C: "El Apagón Logí­stico"
...
- **Instantáneas de Lí­nea Base**: Pruebas de carga semanales con K6 contra el entorno de staging para detectar regresiones de latencia > 10% comparado con la semana anterior.
...
- Establece puntos de referencia (benchmarks) empí­ricos inmutables para los SLAs del sistema.
...
- Requiere entornos de Staging aislados y persistentes configurados para imitar tamaí±os de infraestructura de producción 1:1 para obtener datos de referencia confiables.
