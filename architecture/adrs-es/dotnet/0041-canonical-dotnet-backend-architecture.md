...
**Estado**: Aprobado  
**Fecha**: 2026-05-11  
**Alcance**: Stack Tecnológico - Especí­fico de .NET  
...
*   **Framework**: ASP.NET Core (APIs Mí­nimas optimizadas para contenerización ligera).
...
*   **Flujo de Errores**: Basado en Tipos de Retorno usando librerí­as como `OneOf` u objetos `Result` personalizados, coincidiendo con la mentalidad funcional del [ADR-0038](../nodejs/0038-error-handling-result-pattern-strategy.md).
*   **Así­ncronos/Trabajadores**: Uso de `BackgroundService` (IHostedService) para procesamiento nativo de lotes de alta concurrencia.
...
*   **Simetrí­a de Diseí±o**: Un desarrollador cambiando de Node.js a .NET encontrará la misma separación de Dominio/Aplicación/Infraestructura, reduciendo la fricción.
